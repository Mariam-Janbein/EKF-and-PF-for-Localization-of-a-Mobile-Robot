...
def localize(env, policy, filt, x0, num_steps, plot=False):
    ...
    return position_errors, mahalanobis_errors  # Return exactly two values
...
def analyze_ekf_performance():
    ...
    for r in noise_factors:
        ...
        trials_errors = []
        for _ in range(10):
            errors, _ = localize(env, policy, filt, initial_mean, 10, False)
    ...
    for r in noise_factors:
        ...
        trials_anees = []
        for _ in range(10):
            position_errors, mahalanobis_errors = localize(env, policy, filt, initial_mean, 10, False)
